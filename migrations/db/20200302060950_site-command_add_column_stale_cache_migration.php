...
class AddColumnStaleCacheMigration extends Base {
	...
	public function down() {
		...
		$query .= 'CREATE TABLE sites (
			...
			site_container_fs_path VARCHAR NOT NULL DEFAULT \'/var/www/htdocs\',
		 ...
		 */
		$query .= 'INSERT INTO sites (id, site_url, site_type, site_fs_path, site_container_fs_path, site_enabled, site_ssl, site_ssl_wildcard,cache_nginx_browser,
			...
			SELECT id, site_url, site_type, site_fs_path, site_container_fs_path, site_enabled, site_ssl, site_ssl_wildcard,cache_nginx_browser
			,cache_nginx_fullpage, cache_mysql_query, cache_app_object, cache_host, php_version, db_name, db_user, db_password, db_root_password,
			db_host, db_port,app_sub_type,app_admin_url, app_admin_email, app_admin_password, app_mail, mailhog_enabled,
			admin_tools, created_on, site_auth_scope, site_auth_username, site_auth_password
			FROM sites_backup;';
